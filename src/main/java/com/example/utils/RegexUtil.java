...
public class RegexUtil {
    private static String REGEX_CAR_NUMBER = "^([冀豫云辽黑湘皖鲁苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼渝京津沪新京军空海北沈兰济南广成使领][a-zA-Z](([DF](?![a-zA-Z0-9]*[IO])[0-9]{5})|([0-9]{5}[DF])))|([冀豫云辽黑湘皖鲁苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼渝京津沪新京军空海北沈兰济南广成使领]{1}[A-Z]{1}[a-zA-Z0-9]{4}[a-zA-Z0-9挂学警港澳]{1})$";
    ...
    public static void main(String[] a) {
        ...
        System.out.println(isCarNumber("浙B6307Q"));
        System.out.println(isCarNumber("浙16307挂"));
